...
module Calculation
  ...
  # This function accepts weihted hash liek {'key1' => weight1, 'key2' => weitght2,...}
  # It pick the key with weighted probability
  ...
  # Return hash without keys with corresponding bit '1' in bitmask
